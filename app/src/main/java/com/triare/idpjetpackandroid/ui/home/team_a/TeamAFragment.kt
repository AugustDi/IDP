package com.triare.idpjetpackandroid.ui.home.team_a
...
class TeamAFragment : BaseTeamScoreFragment() {

    private val viewModel: SharedViewModel by activityViewModels()

    override fun getActionText(): String = getString(R.string.goal_a)

    override fun action(binding: FragmentGameBaseBinding) {
        super.action(binding)

        binding.action.setOnClickListener {
            viewModel.goalToTeamA()
        }
    }
}